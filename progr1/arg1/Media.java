...
public class Media {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("double media4: (double)((x + y + z) / 3) = " + media3 + " (cast applicato al risultato della divisione intera)");

    media5 = (double)(x + y + z) / 3;
    System.out.println("double media5: (double)(x + y + z) / 3 = " + media3 + " (cast applicato alla divisione - risultato atteso)");
